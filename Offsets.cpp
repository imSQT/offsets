...
int Offsets::GameTime = 0x31001D0;
int Offsets::ObjectManager = 0x24B80A8;
int Offsets::LocalPlayer = 0x31090E8;
int Offsets::UnderMouseObject = 0x30E95F0;
int Offsets::Chat = 0x310919C;
int Offsets::ViewProjMatrices = 0x31340C8;
int Offsets::Renderer = 0x3136FC8;
int Offsets::MinimapObject = 0x3100210;
